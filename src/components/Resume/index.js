...
function Resume() {
    ...
    <section>
      ...
      <a className="header-format" href="http://docs.google.com/document/d/0B44YFZvutHkjS3JJTGQ2ZGtXSmM/export?format=pdf" target="_blank">Click here to download my resume!</a>
